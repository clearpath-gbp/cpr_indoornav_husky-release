## cpr_indoornav_husky (noetic) - 0.4.3-1

The packages in the `cpr_indoornav_husky` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_husky` on `Fri, 07 Jun 2024 17:17:10 -0000`
...
## cpr_indoornav_husky (noetic) - 0.4.0-1

The packages in the `cpr_indoornav_husky` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_husky` on `Thu, 04 Jan 2024 18:00:51 -0000`
...
## cpr_indoornav_husky (noetic) - 0.3.5-1

The packages in the `cpr_indoornav_husky` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_indoornav_husky` on `Thu, 09 Mar 2023 18:29:01 -0000`
...
## cpr_indoornav_husky (noetic) - 0.3.4-1
